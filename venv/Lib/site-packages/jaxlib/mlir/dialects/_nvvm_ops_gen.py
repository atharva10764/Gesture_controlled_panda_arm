...
class ConvertF32x2ToBF16x2Op(_ods_ir.OpView):
  ...
  def __init__(self, dst, src_hi, src_lo, rbits, *, rnd=None, sat=None, relu=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def src_hi(self) -> _ods_ir.Value:
    return self.operation.operands[0]

  @builtins.property
  def src_lo(self) -> _ods_ir.Value:
    return self.operation.operands[1]

  @builtins.property
  def rbits(self) -> _ods_ir.Value:
...
def convert_f32x2_to_bf16x2(dst, src_hi, src_lo, rbits, *, rnd=None, sat=None, relu=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ConvertF32x2ToBF16x2Op(dst=dst, src_hi=src_hi, src_lo=src_lo, rbits=rbits, rnd=rnd, sat=sat, relu=relu, loc=loc, ip=ip).result
...
def convert_f32x2_to_f16x2(dst, src_hi, src_lo, rbits, *, rnd=None, sat=None, relu=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ConvertF32x2ToF16x2Op(dst=dst, src_hi=src_hi, src_lo=src_lo, rbits=rbits, rnd=rnd, sat=sat, relu=relu, loc=loc, ip=ip).result
